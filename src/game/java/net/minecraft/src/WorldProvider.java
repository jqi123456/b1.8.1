...
public abstract class WorldProvider {
	...
	public IChunkProvider getChunkProvider() {
		return this.worldTypeEnum == EnumWorldType.FLAT
				? new ChunkProviderFlat(this.worldObj, this.worldObj.getRandomSeed(),
						this.worldObj.getWorldInfo().func_35917_r())
				: new ChunkProviderGenerate(this.worldObj, this.worldObj.getRandomSeed(),
						this.worldObj.getWorldInfo().func_35917_r());
	}
	...
	public static WorldProvider getProviderForDimension(int var0) {
		return (WorldProvider) (var0 == -1 ? new WorldProviderHell()
				: (var0 == 0 ? new WorldProviderSurface() : (var0 == 1 ? new WorldProviderSky() : null)));
	}
