		...
		if (this.worldObj.multiplayerWorld) {
			if (this.field_9394_d > 0) {
				...
				this.rotationPitch = (float) ((double) this.rotationPitch
						+ (this.boatPitch - (double) this.rotationPitch) / (double) this.field_9394_d);
				--this.field_9394_d;
			...
			if (var6 > 0.15D) {
				...
				for (int var12 = 0; (double) var12 < 1.0D + var6 * 60.0D; ++var12) {
					...
					if (this.rand.nextBoolean()) {
						...
						this.worldObj.spawnParticle("splash", var17, this.posY - 0.125D, var19, this.motionX, this.motionY,
								this.motionZ);
					} else {
