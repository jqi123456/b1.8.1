...
public class TileEntityRendererPiston extends TileEntitySpecialRenderer {
	...
	public void func_31070_a(TileEntityPiston var1, double var2, double var4, double var6, float var8) {
		...
		if (var9 != null && var1.func_31008_a(var8) < 1.0F) {
			...
			var10.setTranslationD((double) ((float) var2 - (float) var1.xCoord + var1.func_31017_b(var8)),
					(double) ((float) var4 - (float) var1.yCoord + var1.func_31014_c(var8)),
					(double) ((float) var6 - (float) var1.zCoord + var1.func_31013_d(var8)));
			...
			if (var9 == Block.pistonExtension && var1.func_31008_a(var8) < 0.5F) {
				...
				this.field_31071_b.func_31079_a(Block.pistonExtension, var1.xCoord, var1.yCoord, var1.zCoord,
						var1.func_31008_a(var8) < 0.5F);
