...
class RailLogic {
	...
	private boolean isMinecartTrack(int var1, int var2, int var3) {
		return BlockRail.isRailBlockAt(this.worldObj, var1, var2, var3) ? true
				: (BlockRail.isRailBlockAt(this.worldObj, var1, var2 + 1, var3) ? true
						: BlockRail.isRailBlockAt(this.worldObj, var1, var2 - 1, var3));
	}

	private RailLogic getMinecartTrackLogic(ChunkPosition var1) {
		return BlockRail.isRailBlockAt(this.worldObj, var1.x, var1.y, var1.z)
				? new RailLogic(this.rail, this.worldObj, var1.x, var1.y, var1.z)
				: (BlockRail.isRailBlockAt(this.worldObj, var1.x, var1.y + 1, var1.z)
						? new RailLogic(this.rail, this.worldObj, var1.x, var1.y + 1, var1.z)
						: (BlockRail.isRailBlockAt(this.worldObj, var1.x, var1.y - 1, var1.z)
								? new RailLogic(this.rail, this.worldObj, var1.x, var1.y - 1, var1.z)
								: null));
	}
