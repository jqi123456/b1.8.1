...
public class RenderPlayer extends RenderLiving {
	...
	protected void renderSpecials(EntityPlayer var1, float var2) {
		...
		if (var1.username.equals("deadmau5") && this.loadDownloadableImageTexture(var1.skinUrl, (String) null)) {
			for (int var19 = 0; var19 < 2; ++var19) {
				var5 = var1.prevRotationYaw + (var1.rotationYaw - var1.prevRotationYaw) * var2
						- (var1.prevRenderYawOffset + (var1.renderYawOffset - var1.prevRenderYawOffset) * var2);
		...
		/*
		 * B1.8 TODO: if(this.loadDownloadableImageTexture(var1.playerCloakUrl,
		 * (String)null)) {
		 * GL11.glPushMatrix();
		 * GL11.glTranslatef(0.0F, 0.0F, 2.0F / 16.0F);
		 * double var20 = var1.field_20066_r + (var1.field_20063_u - var1.field_20066_r)
		 * * (double) var2 - (var1.prevPosX + (var1.posX - var1.prevPosX) * (double)
		 * var2);
		 * double var22 = var1.field_20065_s + (var1.field_20062_v - var1.field_20065_s)
		 * * (double) var2 - (var1.prevPosY + (var1.posY - var1.prevPosY) * (double)
		 * var2);
		 * double var8 = var1.field_20064_t + (var1.field_20061_w - var1.field_20064_t)
		 * * (double) var2 - (var1.prevPosZ + (var1.posZ - var1.prevPosZ) * (double)
		 * var2);
		 * float var10 = var1.prevRenderYawOffset + (var1.renderYawOffset -
		 ...
		 * }
		 * 
		 * float var18 = var1.prevCameraYaw + (var1.cameraYaw - var1.prevCameraYaw) *
		 * var2;
		 * var15 += MathHelper.sin((var1.prevDistanceWalkedModified +
		 * (var1.distanceWalkedModified - var1.prevDistanceWalkedModified) * var2) *
		 * 6.0F) * 32.0F * var18;
		 * if(var1.isSneaking()) {
		 * var15 += 25.0F;
		 * }
	...
	protected void func_22016_b(EntityPlayer var1, double var2, double var4, double var6) {
		if (var1.isEntityAlive() && var1.isPlayerSleeping()) {
			super.renderLivingAt(var1, var2 + (double) var1.field_22063_x, var4 + (double) var1.field_22062_y,
					var6 + (double) var1.field_22061_z);
		} else {
