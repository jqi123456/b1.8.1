...
public class ItemRenderer {
	...
	public void renderItemInFirstPerson(float var1) {
		...
		var6 = this.mc.theWorld.getLightBrightness(MathHelper.floor_double(var3.posX), MathHelper.floor_double(var3.posY),
				MathHelper.floor_double(var3.posZ));
		var6 = 1.0F;
		int var15 = this.mc.theWorld.func_35451_b(MathHelper.floor_double(var3.posX), MathHelper.floor_double(var3.posY),
		...
		if (var14 != null && var14.itemID == Item.map.shiftedIndex) {
			...
			GL11.glTranslatef(-var10 * 0.4F, MathHelper.sin(MathHelper.sqrt_float(var16) * (float) Math.PI * 2.0F) * 0.2F,
					-var18 * 0.2F);
			...
			if (var3.func_35205_Y() > 0) {
				...
				if (var17 == EnumAction.eat) {
					...
					var12 = var12 * var12 * var12;
					var13 = 1.0F - var12;
					GL11.glTranslatef(0.0F, MathHelper.abs(MathHelper.cos(var18 / 4.0F * (float) Math.PI) * 0.1F)
			...
			var18 = MathHelper.sin(var16 * (float) Math.PI);
			var10 = MathHelper.sin(MathHelper.sqrt_float(var16) * (float) Math.PI);
			GL11.glTranslatef(-var10 * 0.3F, MathHelper.sin(MathHelper.sqrt_float(var16) * (float) Math.PI * 2.0F) * 0.4F,
					-var18 * 0.4F);
	...
	public void updateEquippedItem() {
		...
		if (var2 != null && this.itemToRender != null && var2 != this.itemToRender
				&& var2.itemID == this.itemToRender.itemID && var2.getItemDamage() == this.itemToRender.getItemDamage()) {
