...
public class EntityLiving extends Entity {
	...
	public void playLivingSound() {
		...
		if (var1 != null) {
			this.worldObj.playSoundAtEntity(this, var1, this.getSoundVolume(),
	...
	public void onEntityUpdate() {
		...
		if (this.isEntityAlive() && this.isInsideOfMaterial(Material.water) && !this.canBreatheUnderwater()
				&& !this.field_35170_bR.containsKey(Integer.valueOf(Potion.field_35680_o.field_35670_H))) {
			--this.air;
			if (this.air == -20) {
				this.air = 0;
			...
			if (this.deathTime > 20) {
				...
				for (var1 = 0; var1 < 20; ++var1) {
					...
					this.worldObj.spawnParticle("explode",
							...
							this.posZ + (double) (this.rand.nextFloat() * this.width * 2.0F) - (double) this.width, var9, var10,
							var6);
				}
			}
		}
	...
	protected void fall(float var1) {
		...
		if (var2 > 0) {
			...
			if (var3 > 0) {
				...
				this.worldObj.playSoundAtEntity(this, var4.stepSoundDir2(), var4.getVolume() * 0.5F,
