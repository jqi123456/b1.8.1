									...
									if (var16.blockMaterial == Material.water) {
										...
										if (var15 >= 0 && var15 < 544) {
											...
											if (var12 >= 0 && this.field_1186_c[var18] <= var14) {
												...
												this.field_1180_b[var18] = -16777216 | (int) (this.field_1181_a[var19 * 3 + 0] * var20) << 16
														| (int) (this.field_1181_a[var19 * 3 + 1] * var20) << 8
														| (int) (this.field_1181_a[var19 * 3 + 2] * var20);
											}
											...
											if (var12 < 31) {
												...
												if (this.field_1186_c[var18 + 1] <= var14) {
													...
													this.field_1180_b[var18 + 1] = -16777216
															| (int) (this.field_1181_a[var19 * 3 + 0] * var22) << 16
															| (int) (this.field_1181_a[var19 * 3 + 1] * var22) << 8
															| (int) (this.field_1181_a[var19 * 3 + 2] * var22);
												}
											}
										}
										...
										if (var15 >= -1 && var15 < 543) {
											...
											if (var12 >= 0) {
												...
												if (this.field_1186_c[var18] <= var14 - 1) {
													...
													this.field_1180_b[var18] = -16777216 | (int) (this.field_1181_a[var19 * 3 + 0] * var23) << 16
															| (int) (this.field_1181_a[var19 * 3 + 1] * var23) << 8
															| (int) (this.field_1181_a[var19 * 3 + 2] * var23);
												}
											}
											...
											if (var12 < 31) {
												...
												if (this.field_1186_c[var18 + 1] <= var14 - 1) {
													...
													this.field_1180_b[var18 + 1] = -16777216
															| (int) (this.field_1181_a[var21 * 3 + 0] * var23) << 16
															| (int) (this.field_1181_a[var21 * 3 + 1] * var23) << 8
															| (int) (this.field_1181_a[var21 * 3 + 2] * var23);
												}
											}
										}
									}
