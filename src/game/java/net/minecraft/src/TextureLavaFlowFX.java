	...
	public void onTick() {
		...
		for (int var1 = 0; var1 < 16; ++var1) {
			for (var2 = 0; var2 < 16; ++var2) {
				...
				this.field_1142_h[var1 + var2 * 16] = var3 / 10.0F + (this.field_1141_i[(var1 + 0 & 15) + (var2 + 0 & 15) * 16]
						+ this.field_1141_i[(var1 + 1 & 15) + (var2 + 0 & 15) * 16]
						+ this.field_1141_i[(var1 + 1 & 15) + (var2 + 1 & 15) * 16]
						+ this.field_1141_i[(var1 + 0 & 15) + (var2 + 1 & 15) * 16]) / 4.0F * 0.8F;
