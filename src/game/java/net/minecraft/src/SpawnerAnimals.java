...
public final class SpawnerAnimals {
	...
	protected static final EntitySupplier[] nightSpawnEntities = new EntitySupplier[] { EntitySpider::new,
			EntityZombie::new, EntitySkeleton::new };
	...
	public static final int performSpawning(World var0, boolean var1, boolean var2) {
		if (!var1 && !var2) {
			...
			label112: for (int var35 = 0; var35 < var6; ++var35) {
				EnumCreatureType var36 = var34[var35];
				if ((!var36.getPeacefulCreature() || var2) && (var36.getPeacefulCreature() || var1)
						&& var0.countEntities(var36.getCreatureClass()) <= var36.getMaxNumberOfCreature()
								...
								if (canCreatureTypeSpawnAtLocation(var36, var0, var20, var21, var22)) {
									...
									if (var0.getClosestPlayer((double) var25, (double) var26, (double) var27, 24.0D) == null) {
										...
										if (var31 >= 576.0F) {
											...
											var38.setLocationAndAngles((double) var25, (double) var26, (double) var27,
	...
	private static boolean canCreatureTypeSpawnAtLocation(EnumCreatureType var0, World var1, int var2, int var3,
			int var4) {
		return var0.getCreatureMaterial() == Material.water
				? var1.getBlockMaterial(var2, var3, var4).getIsLiquid() && !var1.isBlockNormalCube(var2, var3 + 1, var4)
				: var1.isBlockNormalCube(var2, var3 - 1, var4) && !var1.isBlockNormalCube(var2, var3, var4)
						&& !var1.getBlockMaterial(var2, var3, var4).getIsLiquid() && !var1.isBlockNormalCube(var2, var3 + 1, var4);
	}
	...
	public static boolean performSleepSpawning(World var0, List var1) {
		...
		while (true) {
			...
			for (int var8 = 0; var8 < 20 && !var7; ++var8) {
				...
				while (!canCreatureTypeSpawnAtLocation(EnumCreatureType.monster, var0, var9, var13, var10)
						&& var13 < var11 + 16) {
					var0.getClass();
					if (var13 >= 128) {
						break;
				...
				if (var13 < var11 + 16) {
					...
					if (var13 < 128) {
						...
						var17.setLocationAndAngles((double) var14, (double) var15, (double) var16, var0.rand.nextFloat() * 360.0F,
								0.0F);
						if (var17.getCanSpawnHere()) {
							...
							if (var18 != null && var18.pathLength > 1) {
								...
								if (Math.abs((double) var19.xCoord - var5.posX) < 1.5D
										&& Math.abs((double) var19.zCoord - var5.posZ) < 1.5D
										&& Math.abs((double) var19.yCoord - var5.posY) < 1.5D) {
									ChunkCoordinates var20 = BlockBed.getNearestEmptyChunkCoordinates(var0,
											MathHelper.floor_double(var5.posX), MathHelper.floor_double(var5.posY),
											MathHelper.floor_double(var5.posZ), 1);
									if (var20 == null) {
										var20 = new ChunkCoordinates(var9, var13 + 1, var10);
									}

									var17.setLocationAndAngles((double) ((float) var20.posX + 0.5F), (double) var20.posY,
											(double) ((float) var20.posZ + 0.5F), 0.0F, 0.0F);
									var0.entityJoinedWorld(var17);
									creatureSpecificInit(var17, var0, (float) var20.posX + 0.5F, (float) var20.posY,
											(float) var20.posZ + 0.5F);
