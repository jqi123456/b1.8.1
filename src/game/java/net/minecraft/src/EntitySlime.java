...
public class EntitySlime extends EntityLiving implements IMob {
	...
	public void onUpdate() {
		...
		if (this.onGround && !var1) {
			...
			for (int var3 = 0; var3 < var2 * 8; ++var3) {
				...
				this.worldObj.spawnParticle("slime", this.posX + (double) var6, this.boundingBox.minY,
	...
	public void setEntityDead() {
		...
		if (!this.worldObj.multiplayerWorld && var1 > 1 && this.health == 0) {
			for (int var2 = 0; var2 < 4; ++var2) {
				...
				var5.setLocationAndAngles(this.posX + (double) var3, this.posY + 0.5D, this.posZ + (double) var4,
	...
	public void onCollideWithPlayer(EntityPlayer var1) {
		int var2 = this.getSlimeSize();
		if (var2 > 1 && this.canEntityBeSeen(var1) && (double) this.getDistanceToEntity(var1) < 0.6D * (double) var2
				&& var1.attackEntityFrom(DamageSource.func_35525_a(this), var2)) {
	...
	public boolean getCanSpawnHere() {
		...
		return (this.getSlimeSize() == 1 || this.worldObj.difficultySetting > 0) && this.rand.nextInt(10) == 0
				&& var1.func_997_a(987234911L).nextInt(10) == 0 && this.posY < 16.0D;
	}
