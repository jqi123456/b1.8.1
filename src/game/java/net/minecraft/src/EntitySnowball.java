...
public class EntitySnowball extends Entity {
	...
	public void onUpdate() {
		...
		if (var3 != null) {
			if (var3.entityHit != null
					&& var3.entityHit.attackEntityFrom(DamageSource.func_35524_a(this, this.shootingEntity), 0)) {
			}
		...
		if (this.isInWater()) {
			for (int var7 = 0; var7 < 4; ++var7) {
				...
				this.worldObj.spawnParticle("bubble", this.posX - this.motionX * (double) var20,
						this.posY - this.motionY * (double) var20, this.posZ - this.motionZ * (double) var20, this.motionX,
	...
	public void onCollideWithPlayer(EntityPlayer var1) {
		if (this.inGroundSnowball && this.shootingEntity == var1 && this.shakeSnowball <= 0
