...
public class EntityWolf extends EntityAnimal {
	...
	public String getEntityTexture() {
		return this.isWolfTamed() ? "/mob/wolf_tame.png"
				: (this.isWolfAngry() ? "/mob/wolf_angry.png" : super.getEntityTexture());
	}
		...
		return this
				.isWolfAngry()
						...
						: (this.rand.nextInt(3) == 0
								? (this.isWolfTamed() && this.dataWatcher.getWatchableObjectInt(18) < 10 ? "mob.wolf.whine"
										: "mob.wolf.panting")
								: "mob.wolf.bark");
	}
	...
	protected void updateEntityActionState() {
		...
		} else if (this.entityToAttack == null && !this.hasPath() && !this.isWolfTamed()
				&& this.worldObj.rand.nextInt(100) == 0) {
			List var1 = this.worldObj.getEntitiesWithinAABB(EntitySheep.class, AxisAlignedBB
					.getBoundingBoxFromPool(this.posX, this.posY, this.posZ, this.posX + 1.0D, this.posY + 1.0D, this.posZ + 1.0D)
			...
			for (int var7 = 0; var7 <= 4; ++var7) {
				for (int var8 = 0; var8 <= 4; ++var8) {
					if ((var7 < 1 || var8 < 1 || var7 > 3 || var8 > 3)
							...
							&& !this.worldObj.isBlockNormalCube(var4 + var7, var6 + 1, var5 + var8)) {
						this.setLocationAndAngles((double) ((float) (var4 + var7) + 0.5F), (double) var6,
								(double) ((float) (var5 + var8) + 0.5F), this.rotationYaw, this.rotationPitch);
						return;
					}
				}
			}
		...
		if (!super.attackEntityFrom(var1, var2)) {
			...
			if (!this.isWolfTamed() && !this.isWolfAngry()) {
				...
				if (var3 instanceof EntityLiving) {
					List var4 = this.worldObj.getEntitiesWithinAABB(EntityWolf.class,
				...
				if (this.isWolfTamed() && var3 instanceof EntityPlayer
						&& ((EntityPlayer) var3).username.equalsIgnoreCase(this.getWolfOwner())) {
					return true;
				}
	...
	protected void attackEntity(Entity var1, float var2) {
		...
		} else if ((double) var2 < 1.5D && var1.boundingBox.maxY > this.boundingBox.minY
	...
	public float setTailRotation() {
		return this.isWolfAngry() ? (float) Math.PI * 0.49F
				: (this.isWolfTamed()
