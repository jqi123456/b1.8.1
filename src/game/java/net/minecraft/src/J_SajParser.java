...
public final class J_SajParser {
	...
	private void arrayString(J_PositionTrackingPushbackReader var1, J_JsonListener var2)
	...
	private void objectString(J_PositionTrackingPushbackReader var1, J_JsonListener var2)
			throws IOException, J_InvalidSyntaxException {
		char var3 = (char) this.readNextNonWhitespaceChar(var1);
		if (var3 != 123) {
			throw new J_InvalidSyntaxException("Expected object to start with { but got [" + var3 + "].", var1);
	...
	private void aFieldToken(J_PositionTrackingPushbackReader var1, J_JsonListener var2)
			throws IOException, J_InvalidSyntaxException {
		char var3 = (char) this.readNextNonWhitespaceChar(var1);
		if (34 != var3) {
			...
			char var4 = (char) this.readNextNonWhitespaceChar(var1);
			if (var4 != 58) {
				throw new J_InvalidSyntaxException("Expected object identifier to be followed by : but got [" + var4 + "].",
						var1);
			} else {
				this.aJsonValue(var1, var2);
				var2.func_27199_h();
	...
	private void aJsonValue(J_PositionTrackingPushbackReader var1, J_JsonListener var2)
			throws IOException, J_InvalidSyntaxException {
		char var3 = (char) this.readNextNonWhitespaceChar(var1);
		switch (var3) {
			case '\"':
			...
			case 'f':
				...
				if (var7 != 4 || var6[0] != 97 || var6[1] != 108 || var6[2] != 115 || var6[3] != 101) {
					...
					throw new J_InvalidSyntaxException(
							"Expected \'f\' to be followed by [[a, l, s, e]], but got [" + Arrays.toString(var6) + "].", var1);
				}
			...
			case 'n':
				...
				if (var9 != 3 || var8[0] != 117 || var8[1] != 108 || var8[2] != 108) {
					...
					throw new J_InvalidSyntaxException(
							"Expected \'n\' to be followed by [[u, l, l]], but got [" + Arrays.toString(var8) + "].", var1);
				}
			...
			case 't':
				...
				if (var5 != 3 || var4[0] != 114 || var4[1] != 117 || var4[2] != 101) {
					...
					throw new J_InvalidSyntaxException(
							"Expected \'t\' to be followed by [[r, u, e]], but got [" + Arrays.toString(var4) + "].", var1);
				}
	...
	private String nonNegativeNumberToken(J_PositionTrackingPushbackReader var1)
			throws IOException, J_InvalidSyntaxException {
		StringBuilder var2 = new StringBuilder();
		char var3 = (char) var1.read();
		if (48 == var3) {
	...
	private String possibleFractionalComponent(J_PositionTrackingPushbackReader var1)
			throws IOException, J_InvalidSyntaxException {
		StringBuilder var2 = new StringBuilder();
		char var3 = (char) var1.read();
		if (var3 == 46) {
	...
	private int hexadecimalNumber(J_PositionTrackingPushbackReader var1) throws IOException, J_InvalidSyntaxException {
		...
		if (var3 != 4) {
			throw new J_InvalidSyntaxException("Expected a 4 digit hexidecimal number but got only [" + var3 + "], namely ["
					+ String.valueOf(var2, 0, var3) + "].", var1);
		} else {
			try {
				...
				throw new J_InvalidSyntaxException("Unable to parse [" + String.valueOf(var2) + "] as a hexidecimal number.",
						var6, var1);
			}
		}
	}
