...
public class RenderFish extends Render {
	public void doRenderFish(EntityFish var1, double var2, double var4, double var6, float var8, float var9) {
		...
		GL11.glPopMatrix();
		if (var1.angler != null) {
			float var20 = (var1.angler.prevRotationYaw + (var1.angler.rotationYaw - var1.angler.prevRotationYaw) * var9)
			...
			var27.rotateAroundX(
					-(var1.angler.prevRotationPitch + (var1.angler.rotationPitch - var1.angler.prevRotationPitch) * var9)
							* (float) Math.PI / 180.0F);
			var27
					.rotateAroundY(-(var1.angler.prevRotationYaw + (var1.angler.rotationYaw - var1.angler.prevRotationYaw) * var9)
							* (float) Math.PI / 180.0F);
			...
			if (this.renderManager.options.thirdPersonView) {
				var20 = (var1.angler.prevRenderYawOffset
						+ (var1.angler.renderYawOffset - var1.angler.prevRenderYawOffset) * var9) * (float) Math.PI / 180.0F;
				var21 = (double) MathHelper.sin(var20);
				var23 = (double) MathHelper.cos(var20);
				var28 = var1.angler.prevPosX + (var1.angler.posX - var1.angler.prevPosX) * (double) var9 - var23 * 0.35D
						- var21 * 0.85D;
				var30 = var1.angler.prevPosY + (var1.angler.posY - var1.angler.prevPosY) * (double) var9 - 0.45D;
				var32 = var1.angler.prevPosZ + (var1.angler.posZ - var1.angler.prevPosZ) * (double) var9 - var21 * 0.35D
						+ var23 * 0.85D;
			}
			...
			for (int var47 = 0; var47 <= var46; ++var47) {
				...
				var12.addVertex(var2 + var40 * (double) var48, var4 + var42 * (double) (var48 * var48 + var48) * 0.5D + 0.25D,
