	...
	protected void genAchievementBackground(int var1, int var2, float var3) {
		...
		for (var14 = 0; var14 < AchievementList.achievementList.size(); ++var14) {
			...
			if (var16 >= -24 && var17 >= -24 && var16 <= 224 && var17 <= 155) {
				...
				if (var1 >= var10 && var2 >= var11 && var1 < var10 + 224 && var2 < var11 + 155 && var1 >= var33
						&& var1 <= var33 + 22 && var2 >= var34 && var2 <= var34 + 22) {
					var27 = var30;
				}
			}
		}
		...
		if (var27 != null) {
			...
			this.fontRenderer.drawStringWithShadow(var31, var17, var33,
					this.statFileWriter.canUnlockAchievement(var27) ? (var27.getSpecial() ? -128 : -1)
