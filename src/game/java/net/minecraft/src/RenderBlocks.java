...
public class RenderBlocks {
	...
	public boolean func_35927_a(int var1, int var2, int var3, int var4) {
		if (this != null) {
			...
			if (var9 <= var7 && var8 <= var7 && (var8 == var7 || var9 == var7)
					&& this.field_35942_c[this.blockAccess.getBlockId(var1, var2, var3)]) {
				int var10 = 5;
				if (var1 == var5 - var7) {
					--var10;
				}
				...
				: (var5 == 4 ? this.renderBlockFluids(var1, var2, var3, var4)
						: (var5 == 13 ? this.renderBlockCactus(var1, var2, var3, var4)
								: (var5 == 1 ? this.renderBlockReed(var1, var2, var3, var4)
										: (var5 == 19 ? this.renderBlockCrops(var1, var2, var3, var4)
												: (var5 == 6 ? this.func_35930_l(var1, var2, var3, var4)
																		...
																		: (var5 == 5 ? this.renderBlockRedstoneWire(var1, var2, var3, var4)
																				: (var5 == 8 ? this.renderBlockLadder(var1, var2, var3, var4)
																						: (var5 == 7 ? this.renderBlockDoor(var1, var2, var3, var4)
																								: (var5 == 9
																										? this.renderBlockMinecartTrack((BlockRail) var1, var2, var3, var4)
																										: (var5 == 10 ? this.renderBlockStairs(var1, var2, var3, var4)
																												: (var5 == 11
																														? this.func_35925_a((BlockFence) var1, var2, var3, var4)
																														: (var5 == 12
																																? this.renderBlockLever(var1, var2, var3, var4)
																																: (var5 == 14
																																		? this.renderBlockBed(var1, var2, var3, var4)
																																		: (var5 == 15
																																				? this.renderBlockRepeater(var1, var2, var3,
																																						var4)
																																				: (var5 == 16
																																						? this.renderPistonBase(var1, var2, var3,
																																								var4, false)
																																						: (var5 == 17
																																								? this.renderPistonExtension(var1, var2,
																																										var3, var4, true)
																																								: (var5 == 18 ? this.func_35922_a(
																																										(BlockPane) var1, var2, var3, var4)
																																										: (var5 == 20
																																												? this.func_35929_i(var1, var2,
																																														var3, var4)
																																												: (var5 == 21
																																														? this.func_35923_a(
																																																(BlockFenceGate) var1,
	...
	private void func_31076_a(double var1, double var3, double var5, double var7, double var9, double var11, float var13,
			double var14) {
		int var16 = 108;
	...
	private void func_31081_b(double var1, double var3, double var5, double var7, double var9, double var11, float var13,
			double var14) {
		int var16 = 108;
		if (this.overrideBlockTexture >= 0) {
			var16 = this.overrideBlockTexture;
	...
	private void func_31077_c(double var1, double var3, double var5, double var7, double var9, double var11, float var13,
			double var14) {
		int var16 = 108;
		if (this.overrideBlockTexture >= 0) {
			var16 = this.overrideBlockTexture;
	...
	private boolean renderPistonExtension(Block var1, int var2, int var3, int var4, boolean var5) {
		...
		switch (var7) {
			case 0:
				...
				this.renderStandardBlock(var1, var2, var3, var4);
				this.func_31076_a((double) ((float) var2 + 6.0F / 16.0F), (double) ((float) var2 + 10.0F / 16.0F),
				...
				this.func_31076_a((double) ((float) var2 + 10.0F / 16.0F), (double) ((float) var2 + 6.0F / 16.0F),
						(double) ((float) var3 + 0.25F), (double) ((float) var3 + 0.25F + var12),
						(double) ((float) var4 + 6.0F / 16.0F), (double) ((float) var4 + 6.0F / 16.0F), var11 * 0.8F, var13);
				this.func_31076_a((double) ((float) var2 + 6.0F / 16.0F), (double) ((float) var2 + 6.0F / 16.0F),
						(double) ((float) var3 + 0.25F), (double) ((float) var3 + 0.25F + var12),
						(double) ((float) var4 + 6.0F / 16.0F), (double) ((float) var4 + 10.0F / 16.0F), var11 * 0.6F, var13);
				this.func_31076_a((double) ((float) var2 + 10.0F / 16.0F), (double) ((float) var2 + 10.0F / 16.0F),
						(double) ((float) var3 + 0.25F), (double) ((float) var3 + 0.25F + var12),
			...
			case 2:
				...
				this.renderStandardBlock(var1, var2, var3, var4);
				this.func_31081_b((double) ((float) var2 + 6.0F / 16.0F), (double) ((float) var2 + 6.0F / 16.0F),
				...
				this.func_31081_b((double) ((float) var2 + 10.0F / 16.0F), (double) ((float) var2 + 10.0F / 16.0F),
						(double) ((float) var3 + 6.0F / 16.0F), (double) ((float) var3 + 10.0F / 16.0F),
						(double) ((float) var4 + 0.25F), (double) ((float) var4 + 0.25F + var12), var11 * 0.6F, var13);
				this.func_31081_b((double) ((float) var2 + 6.0F / 16.0F), (double) ((float) var2 + 10.0F / 16.0F),
				...
				this.func_31081_b((double) ((float) var2 + 10.0F / 16.0F), (double) ((float) var2 + 6.0F / 16.0F),
			...
			case 4:
				...
				this.renderStandardBlock(var1, var2, var3, var4);
				this.func_31077_c((double) ((float) var2 + 0.25F), (double) ((float) var2 + 0.25F + var12),
						(double) ((float) var3 + 6.0F / 16.0F), (double) ((float) var3 + 6.0F / 16.0F),
			...
			case 5:
				...
				this.renderStandardBlock(var1, var2, var3, var4);
				this.func_31077_c((double) ((float) var2 - 0.25F + 1.0F - var12), (double) ((float) var2 - 0.25F + 1.0F),
						(double) ((float) var3 + 6.0F / 16.0F), (double) ((float) var3 + 6.0F / 16.0F),
						(double) ((float) var4 + 10.0F / 16.0F), (double) ((float) var4 + 6.0F / 16.0F), var11 * 0.5F, var13);
				this.func_31077_c((double) ((float) var2 - 0.25F + 1.0F - var12), (double) ((float) var2 - 0.25F + 1.0F),
						(double) ((float) var3 + 10.0F / 16.0F), (double) ((float) var3 + 10.0F / 16.0F),
		...
		for (int var6 = 0; var6 < 6; ++var6) {
			...
			if ((var6 != 2 && var6 != 3 || (var1 - 1) / 3 != 1) && (var6 != 4 && var6 != 5 || (var1 - 1) % 3 != 1)) {
				...
				if (!this.field_35942_c[this.blockAccess.getBlockId(var7, var8, var9)]) {
					...
					if (var6 == 0) {
						var5.addVertexWithUV((double) var2 + var41, (double) (var3 + 1) + var39, (double) var4 + var41, var25,
								var33);
						var5.addVertexWithUV((double) var2 + var41, (double) (var3 + 1) + var39, (double) var4 + var43, var27,
								var35);
						var5.addVertexWithUV((double) var2 + var43, (double) (var3 + 1) + var39, (double) var4 + var43, var29,
								var37);
						var5.addVertexWithUV((double) var2 + var43, (double) (var3 + 1) + var39, (double) var4 + var41, var23,
								var31);
					} else if (var6 == 1) {
						var5.addVertexWithUV((double) var2 + var41, (double) (var3 + 0) - var39, (double) var4 + var43, var27,
								var35);
						var5.addVertexWithUV((double) var2 + var41, (double) (var3 + 0) - var39, (double) var4 + var41, var25,
								var33);
						var5.addVertexWithUV((double) var2 + var43, (double) (var3 + 0) - var39, (double) var4 + var41, var23,
								var31);
						var5.addVertexWithUV((double) var2 + var43, (double) (var3 + 0) - var39, (double) var4 + var43, var29,
								var37);
					} else if (var6 == 2) {
						var5.addVertexWithUV((double) (var2 + 1) + var39, (double) var3 + var41, (double) var4 + var43, var27,
								var35);
						var5.addVertexWithUV((double) (var2 + 1) + var39, (double) var3 + var41, (double) var4 + var41, var25,
								var33);
						var5.addVertexWithUV((double) (var2 + 1) + var39, (double) var3 + var43, (double) var4 + var41, var23,
								var31);
						var5.addVertexWithUV((double) (var2 + 1) + var39, (double) var3 + var43, (double) var4 + var43, var29,
								var37);
					} else if (var6 == 3) {
						var5.addVertexWithUV((double) (var2 + 0) - var39, (double) var3 + var41, (double) var4 + var41, var25,
								var33);
						var5.addVertexWithUV((double) (var2 + 0) - var39, (double) var3 + var41, (double) var4 + var43, var27,
								var35);
						var5.addVertexWithUV((double) (var2 + 0) - var39, (double) var3 + var43, (double) var4 + var43, var29,
								var37);
						var5.addVertexWithUV((double) (var2 + 0) - var39, (double) var3 + var43, (double) var4 + var41, var23,
								var31);
					} else if (var6 == 4) {
						var5.addVertexWithUV((double) var2 + var41, (double) var3 + var43, (double) (var4 + 1) + var39, var27,
								var35);
						var5.addVertexWithUV((double) var2 + var41, (double) var3 + var41, (double) (var4 + 1) + var39, var25,
								var33);
						var5.addVertexWithUV((double) var2 + var43, (double) var3 + var41, (double) (var4 + 1) + var39, var23,
								var31);
						var5.addVertexWithUV((double) var2 + var43, (double) var3 + var43, (double) (var4 + 1) + var39, var29,
								var37);
					} else if (var6 == 5) {
						var5.addVertexWithUV((double) var2 + var43, (double) var3 + var41, (double) (var4 + 0) - var39, var23,
								var31);
						var5.addVertexWithUV((double) var2 + var41, (double) var3 + var41, (double) (var4 + 0) - var39, var25,
								var33);
						var5.addVertexWithUV((double) var2 + var41, (double) var3 + var43, (double) (var4 + 0) - var39, var27,
								var35);
						var5.addVertexWithUV((double) var2 + var43, (double) var3 + var43, (double) (var4 + 0) - var39, var29,
								var37);
					}
				}
			}
	...
	public boolean renderBlockCrops(Block var1, int var2, int var3, int var4) {
		...
		if (var15 < 0) {
			this.func_35928_a(var5, this.blockAccess.getBlockMetadata(var2, var3, var4), var5.maxY, (double) var2,
					(double) var3, (double) var4);
		} else {
			this.func_35928_a(var5, this.blockAccess.getBlockMetadata(var2, var3, var4), 0.5D, (double) var2, (double) var3,
					(double) var4);
			this.func_35926_a(var5, this.blockAccess.getBlockMetadata(var2, var3, var4), var15, var5.maxY, (double) var2,
					(double) var3, (double) var4);
		}
	...
	public boolean func_35930_l(Block var1, int var2, int var3, int var4) {
		...
		var5.func_35835_b(var1.func_35275_c(this.blockAccess, var2, var3, var4));
		var5.setColorOpaque_F(1.0F, 1.0F, 1.0F);
		this.func_1245_b(var1, this.blockAccess.getBlockMetadata(var2, var3, var4), (double) var2,
	...
	public boolean renderBlockFluids(Block var1, int var2, int var3, int var4) {
		...
		if (!var10 && !var11 && !var12[0] && !var12[1] && !var12[2] && !var12[3]) {
			...
			if (this.renderAllFaces || var10) {
				...
				var5.addVertexWithUV((double) (var2 + 0), (double) var3 + var24, (double) (var4 + 0), var36 - var42 - var40,
						var38 - var42 + var40);
				var5.addVertexWithUV((double) (var2 + 0), (double) var3 + var26, (double) (var4 + 1), var36 - var42 + var40,
						var38 + var42 + var40);
				var5.addVertexWithUV((double) (var2 + 1), (double) var3 + var28, (double) (var4 + 1), var36 + var42 + var40,
						var38 + var42 - var40);
				var5.addVertexWithUV((double) (var2 + 1), (double) var3 + var30, (double) (var4 + 0), var36 + var42 - var40,
						var38 - var42 - var40);
			}
	...
	public boolean func_35925_a(BlockFence var1, int var2, int var3, int var4) {
		...
		boolean var8 = false;
		boolean var9 = false;
		if (var1.func_35303_f(this.blockAccess, var2 - 1, var3, var4)
				|| var1.func_35303_f(this.blockAccess, var2 + 1, var3, var4)) {
			var8 = true;
		}

		if (var1.func_35303_f(this.blockAccess, var2, var3, var4 - 1)
				|| var1.func_35303_f(this.blockAccess, var2, var3, var4 + 1)) {
			var9 = true;
		}
	...
	public static boolean renderItemIn3d(int var0) {
		return var0 == 0 ? true
				: (var0 == 13 ? true
						: (var0 == 10 ? true : (var0 == 11 ? true : (var0 == 22 ? true : (var0 == 21 ? true : var0 == 16)))));
	}
}
