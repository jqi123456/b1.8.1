...
public class EntityArrow extends Entity {
	...
	public EntityArrow(World var1, EntityLiving var2, float var3) {
		...
		this.setSize(0.5F, 0.5F);
		this.setLocationAndAngles(var2.posX, var2.posY + (double) var2.getEyeHeight(), var2.posZ, var2.rotationYaw,
				var2.rotationPitch);
	...
	public void setVelocity(double var1, double var3, double var5) {
		...
		if (this.prevRotationPitch == 0.0F && this.prevRotationYaw == 0.0F) {
			...
			this.prevRotationYaw = this.rotationYaw = (float) (Math.atan2(var1, var5) * 180.0D / (double) ((float) Math.PI));
			this.prevRotationPitch = this.rotationPitch = (float) (Math.atan2(var3, (double) var7) * 180.0D
					/ (double) ((float) Math.PI));
	...
	public void onUpdate() {
		...
		if (var15 > 0) {
			...
			AxisAlignedBB var2 = Block.blocksList[var15].getCollisionBoundingBoxFromPool(this.worldObj, this.xTile,
		...
		if (this.inGround) {
			...
			if (this.field_35140_d) {
				for (var8 = 0; var8 < 4; ++var8) {
					this.worldObj.spawnParticle("crit", this.posX + this.motionX * (double) var8 / 4.0D,
							this.posY + this.motionY * (double) var8 / 4.0D, this.posZ + this.motionZ * (double) var8 / 4.0D,
			...
			for (this.rotationPitch = (float) (Math.atan2(this.motionY, (double) var19) * 180.0D
			...
			if (this.isInWater()) {
				for (int var22 = 0; var22 < 4; ++var22) {
					float var23 = 0.25F;
					this.worldObj.spawnParticle("bubble", this.posX - this.motionX * (double) var23,
							this.posY - this.motionY * (double) var23, this.posZ - this.motionZ * (double) var23, this.motionX,
	...
	public void onCollideWithPlayer(EntityPlayer var1) {
		if (!this.worldObj.multiplayerWorld) {
			if (this.inGround && this.doesArrowBelongToPlayer && this.arrowShake <= 0
					&& var1.inventory.addItemStackToInventory(new ItemStack(Item.arrow, 1))) {
