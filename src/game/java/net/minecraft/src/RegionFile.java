...
public class RegionFile {
	...
	private void func_22197_a(String var1, int var2, int var3, int var4, String var5) {
		this.debug(
				"REGION " + var1 + " " + this.fileName.getName() + "[" + var2 + "," + var3 + "] " + var4 + "B = " + var5);
	}
	...
	public DataInputStream getChunkDataInputStream(int var1, int var2) {
	...
	public DataOutputStream getChunkDataOutputStream(int var1, int var2) {
		return this.outOfBounds(var1, var2) ? null
				: new DataOutputStream(new DeflaterOutputStream(new RegionFileChunkBuffer(this, var1, var2)));
	}

	protected void write(int var1, int var2, byte[] var3, int var4) {
		try {
