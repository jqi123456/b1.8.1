...
public class EntityRenderer {
	...
	public void updateRenderer() {
		...
		float var1 = this.mc.theWorld.getLightBrightness(MathHelper.floor_double(this.mc.renderViewEntity.posX),
	...
	private void func_4135_b(float var1, int var2) {
		if (this.field_35823_q <= 0) {
			...
			if (this.cameraZoom != 1.0D) {
				GL11.glTranslatef((float) this.cameraYaw, (float) (-this.cameraPitch), 0.0F);
				GL11.glScaled(this.cameraZoom, this.cameraZoom, 1.0D);
				GLU.gluPerspective(this.getFOVModifier(var1, false),
	...
	private void func_35807_d() {
		this.field_35816_f = (float) ((double) this.field_35816_f
				+ (Math.random() - Math.random()) * Math.random() * Math.random());
		this.field_35821_h = (float) ((double) this.field_35821_h
				+ (Math.random() - Math.random()) * Math.random() * Math.random());
	...
	public void renderWorld(float var1, long var2) {
		...
		for (int var18 = 0; var18 < 2; ++var18) {
			...
			GL11.glEnable(GL11.GL_CULL_FACE);
			GL11.glDisable(GL11.GL_BLEND);
			if (this.cameraZoom == 1.0D && var4 instanceof EntityPlayer && this.mc.objectMouseOver != null
	...
	private void addRainParticles() {
		...
		if (var1 != 0.0F) {
			...
			if (var14 > 0 && this.random.nextInt(3) < this.rainSoundCounter++) {
				...
				if (var10 > var2.posY + 1.0D && var3.func_35461_e(MathHelper.floor_double(var2.posX),
	...
	protected void renderRainSnow(float var1) {
		...
		if (var2 > 0.0F) {
			...
			BiomeGenBase[] var17 = var42.getWorldChunkManager().func_4069_a(var43 - var16, var45 - var16, var16 * 2 + 1,
					var16 * 2 + 1);
			boolean var18 = false;
			byte var19 = -1;
			...
			for (int var21 = var43 - var16; var21 <= var43 + var16; ++var21) {
				for (int var22 = var45 - var16; var22 <= var45 + var16; ++var22) {
					...
					if (var26.canSpawnLightningBolt() || var26.getEnableSnow()) {
						...
						if (var28 != var29) {
							this.random
									.setSeed((long) (var21 * var21 * 3121 + var21 * 45238971 ^ var22 * var22 * 418711 + var22 * 13761));
							float var32;
							double var35;
							if (var26.canSpawnLightningBolt()) {
								...
								var32 = ((float) (this.rendererUpdateCount + var21 * var21 * 3121 + var21 * 45238971
										+ var22 * var22 * 418711 + var22 * 13761 & 31) + var1) / 32.0F * (3.0F + this.random.nextFloat());
								...
								var8.addVertexWithUV((double) ((float) var21 - var24) + 0.5D, (double) var28,
										(double) ((float) var22 - var25) + 0.5D, (double) (0.0F * var30),
										(double) ((float) var28 * var30 / 4.0F + var32 * var30));
								var8.addVertexWithUV((double) ((float) var21 + var24) + 0.5D, (double) var28,
										(double) ((float) var22 + var25) + 0.5D, (double) (1.0F * var30),
										(double) ((float) var28 * var30 / 4.0F + var32 * var30));
								var8.addVertexWithUV((double) ((float) var21 + var24) + 0.5D, (double) var29,
										(double) ((float) var22 + var25) + 0.5D, (double) (1.0F * var30),
										(double) ((float) var29 * var30 / 4.0F + var32 * var30));
								var8.addVertexWithUV((double) ((float) var21 - var24) + 0.5D, (double) var29,
										(double) ((float) var22 - var25) + 0.5D, (double) (0.0F * var30),
										(double) ((float) var29 * var30 / 4.0F + var32 * var30));
								...
								var8.setTranslationD(-var9 * 1.0D, -var11 * 1.0D, -var13 * 1.0D);
								var8.addVertexWithUV((double) ((float) var21 - var24) + 0.5D, (double) var28,
										(double) ((float) var22 - var25) + 0.5D, (double) (0.0F * var30 + var47),
										(double) ((float) var28 * var30 / 4.0F + var32 * var30 + var34));
								var8.addVertexWithUV((double) ((float) var21 + var24) + 0.5D, (double) var28,
										(double) ((float) var22 + var25) + 0.5D, (double) (1.0F * var30 + var47),
										(double) ((float) var28 * var30 / 4.0F + var32 * var30 + var34));
								var8.addVertexWithUV((double) ((float) var21 + var24) + 0.5D, (double) var29,
										(double) ((float) var22 + var25) + 0.5D, (double) (1.0F * var30 + var47),
										(double) ((float) var29 * var30 / 4.0F + var32 * var30 + var34));
								var8.addVertexWithUV((double) ((float) var21 - var24) + 0.5D, (double) var29,
										(double) ((float) var22 - var25) + 0.5D, (double) (0.0F * var30 + var47),
										(double) ((float) var29 * var30 / 4.0F + var32 * var30 + var34));
								var8.setTranslationD(0.0D, 0.0D, 0.0D);
	...
	private void updateFogColor(float var1) {
		...
		float var11;
		if (this.mc.gameSettings.renderDistance < 2) {
			Vec3D var10 = MathHelper.sin(var2.func_35456_d(var1)) > 0.0F ? Vec3D.createVector(0.0D, 0.0D, 1.0D)
					: Vec3D.createVector(0.0D, 0.0D, -1.0D);
		...
		double var13 = (var3.lastTickPosY + (var3.posY - var3.lastTickPosY) * (double) var1)
				/ var2.worldProvider.func_46065_j();
		if (var13 < 1.0D) {
			if (var13 < 0.0D) {
				var13 = 0.0D;
			}
	...
	private void setupFog(int var1, float var2) {
		...
		if (var3 instanceof EntityPlayer)
			var11 = ((EntityPlayer) var3).field_35212_aW.field_35756_d;
		if (var1 == 999) {
			...
			if (this.cloudFog) {
				...
				if (this.mc.theWorld.worldProvider.func_46064_i() && !var11) {
					double var10 = (double) ((var3.func_35115_a(var2) & 15728640) >> 20) / 16.0D
