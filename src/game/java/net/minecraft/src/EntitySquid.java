...
public class EntitySquid extends EntityWaterMob {
	...
	public boolean isInWater() {
		return this.worldObj.handleMaterialAcceleration(this.boundingBox.expand(0.0D, (double) -0.6F, 0.0D), Material.water,
				this);
	}
	...
	public void onLivingUpdate() {
		...
		if (this.isInWater()) {
			...
			this.field_21089_a += (-((float) Math.atan2((double) var1, this.motionY)) * 180.0F / (float) Math.PI
					- this.field_21089_a) * 0.1F;
		} else {
