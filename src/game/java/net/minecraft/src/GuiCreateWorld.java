...
public class GuiCreateWorld extends GuiScreen {
	...
	public void initGui() {
		...
		this.controlList.add(this.field_35366_j = new GuiButton(2, this.width / 2 - 75, 100, 150, 20,
				var1.translateKey("selectWorld.gameMode")));
		this.controlList.add(this.field_35367_k = new GuiButton(3, this.width / 2 - 75, 172, 150, 20,
				var1.translateKey("selectWorld.moreWorldOptions")));
		this.controlList.add(this.field_35372_s = new GuiButton(4, this.width / 2 - 155, 100, 150, 20,
				var1.translateKey("selectWorld.mapFeatures")));
		this.field_35372_s.enabled2 = false;
		this.controlList.add(this.field_35371_t = new GuiButton(5, this.width / 2 + 5, 100, 150, 20,
	...
	private void func_35363_g() {
		StringTranslate var1 = StringTranslate.getInstance();
		this.field_35366_j.displayString = var1.translateKey("selectWorld.gameMode") + " "
				+ var1.translateKey("selectWorld.gameMode." + this.field_35364_f);
		...
		this.field_35371_t.displayString = var1.translateKey("selectWorld.mapType") + " "
				+ var1.translateKey(EnumWorldType.values()[this.worldType].func_46136_a());
	}
		...
		if (var1.enabled) {
			if (var1.id == 1) {
				...
				this.mc.startWorld(this.folderName, this.textboxWorldName.getText(),
						new WorldSettings(var2, var9, this.field_35365_g, EnumWorldType.values()[this.worldType]));
				this.mc.displayGuiScreen((GuiScreen) null);
			} else if (var1.id == 3) {
