...
public class Minecraft implements Runnable {
	...
	private static EnumOS2 getOs() {
		...
		return var0.contains("win") ? EnumOS2.windows
				: (var0.contains("mac") ? EnumOS2.macos
						: (var0.contains("solaris") ? EnumOS2.solaris
								: (var0.contains("sunos") ? EnumOS2.solaris
										: (var0.contains("linux") ? EnumOS2.linux
				...
				while (true) {
					do {
						if (!Keyboard.next()) {
							...
							if (this.gameSettings.field_35381_w.field_35965_e && this.field_35001_ab == 0
									&& !this.thePlayer.func_35196_Z()) {
								this.clickMouse(1);
							}

							this.sendClickBlockToController(0,
									this.currentScreen == null && this.gameSettings.field_35382_v.field_35965_e && this.inGameHasFocus);
							break label274;
						}
	...
	public void usePortal() {
		...
		if (this.thePlayer.dimension == -1) {
			var1 /= var5;
			var3 /= var5;
			this.thePlayer.setLocationAndAngles(var1, this.thePlayer.posY, var3, this.thePlayer.rotationYaw,
	...
	public void respawn(boolean var1, int var2) {
		...
		if (var5) {
			...
			this.thePlayer.setLocationAndAngles((double) ((float) var4.posX + 0.5F), (double) ((float) var4.posY + 0.1F),
					(double) ((float) var4.posZ + 0.5F), 0.0F, 0.0F);
		}
